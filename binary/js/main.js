...
$('.goto').click(function() {
		...
		var offset=0;
	$('body,html').animate({scrollTop:$('.'+el).offset().top+offset},1000, function() {});
...
$('.filter__item').click(function(event){
	...
	if (filterIndex == 1) {
		...
		$('.portfolio__column.f_' + filterIndex).show();
	}
...
$('.menu__link').click(function(){
	$('.menu__link').removeClass('menu__link_act');
	$(this).addClass('menu__link_act');
});
});
